  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      try {
        ...
        logger.error({ err: error }, "Generic webhook error");
        captureAndFlush(error, { tags: { source: "revenue.ts:71" } });
