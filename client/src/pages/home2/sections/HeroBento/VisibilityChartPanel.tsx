      ...
      <div className="flex flex-col h-full min-h-[260px] lg:min-h-0">
        <div className="flex items-center justify-between px-5 pt-4 pb-3">
          <div className="flex items-center gap-3">
            <p className="text-[11px] font-medium text-tk-secondary">Visibility over time</p>
          </div>
          <div className="flex items-center gap-2">
            <div className="relative inline-grid grid-cols-3 bg-tk-muted/60 rounded p-0.5 border border-tk-default/40">
              <div
                aria-hidden="true"
              ...
              <button
                type="button"
                className="relative z-[1] px-2.5 py-1 text-[11px] font-medium rounded transition-colors duration-200 cursor-pointer text-tk-text-muted hover:text-tk-secondary"
              >
                7D
              </button>
              <button
              ...
              <button
                type="button"
                className="relative z-[1] px-2.5 py-1 text-[11px] font-medium rounded transition-colors duration-200 cursor-pointer text-tk-primary"
              >
                30D
              </button>
            </div>
