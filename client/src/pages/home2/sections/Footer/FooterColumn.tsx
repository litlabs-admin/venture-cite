...
const SIZE = {
  mobile: {
    label: "text-[9px] font-semibold uppercase tracking-[0.08em] text-tk-text-muted mb-2",
    list: "space-y-1.5",
    link: "block text-[11px] text-tk-secondary hover:text-tk-accent transition-colors",
  },
  desktop: {
    label: "text-[10px] font-semibold uppercase tracking-[0.08em] text-tk-text-muted mb-3",
    list: "space-y-2",
    link: "block text-[12px] text-tk-secondary hover:text-tk-accent transition-colors duration-150",
  },
} as const;
