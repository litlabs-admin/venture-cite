...
export function Footer() {
  ...
  return (
    <footer className="bg-tk-surface">
      <div className="bg-tk-surface border-y border-tk-default relative">
        <div className="px-4 sm:px-6 lg:px-8 mx-auto" style={{ maxWidth: "1184px" }}>
          ...
          <div className="sm:hidden py-6">
            <div
              className={`flex items-start gap-3 mb-5 pb-5 border-b border-tk-default ${revealY(isVisible)}`}
            >
              <a href="/" className="flex-shrink-0">
                <img src={logoPath} alt="VentureCite" className="h-6 w-auto" />
              </a>
              <p className="text-[11px] text-tk-secondary leading-relaxed">
                Get cited by AI search engines. Track every mention. Optimize every prompt.
              </p>
            </div>

            <div
              className={`grid grid-cols-4 gap-4 mb-5 pb-5 border-b border-tk-default ${revealY(isVisible)}`}
            ...
            <div className={revealY(isVisible)} style={{ transitionDelay: "100ms" }}>
              <a
                href="/register"
                className="h-9 w-full bg-tk-accent-subtle text-tk-accent text-[12px] font-medium rounded flex items-center justify-center hover:bg-tk-accent hover:text-white transition-all duration-150"
              >
                Get started →
              </a>
            </div>
          ...
          <div className="hidden sm:grid grid-cols-3 lg:grid-cols-[180px_1fr_1fr_1fr_1fr_160px] gap-6 lg:gap-0 py-10 lg:py-0">
            <div
              className={`col-span-3 lg:col-span-1 lg:py-10 lg:px-6 lg:border-r border-tk-default flex flex-col ${revealY(
                isVisible,
              )}`}
            >
              ...
              <p className="text-[12px] text-tk-secondary leading-relaxed mb-4 max-w-[180px]">
                Get cited by AI search engines. Track every mention. Optimize every prompt.
              </p>
              <div className="flex items-center gap-2">
                <a
                  ...
                  aria-label="LinkedIn"
                  className="w-7 h-7 rounded border border-tk-default flex items-center justify-center text-tk-text-muted hover:text-tk-accent hover:border-tk-accent hover:bg-tk-accent-subtle transition-all duration-150"
                >
            ...
            <div
              className={`lg:py-8 lg:px-5 lg:border-r border-tk-default ${revealY(isVisible)}`}
              style={{ transitionDelay: "50ms" }}
            >
            ...
            <div
              className={`col-span-3 lg:col-span-1 lg:py-8 lg:px-5 lg:border-r border-tk-default ${revealY(
                isVisible,
              )}`}
            ...
            >
              <div className="text-[10px] font-semibold uppercase tracking-[0.08em] text-tk-text-muted mb-2">
                Get started
              </div>
              <a
                href="/register"
                className="h-9 px-4 bg-tk-accent-subtle text-tk-accent text-[13px] font-medium rounded flex items-center justify-center hover:bg-tk-accent hover:text-white transition-all duration-150"
              >
                Get started →
              </a>
            </div>
      ...
      <div className="px-4 sm:px-6 lg:px-16 mx-auto" style={{ maxWidth: "1184px" }}>
        ...
        >
          <span className="text-[10px] sm:text-[11px] text-tk-text-muted">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <span className="inline-flex items-center gap-1.5 text-[9px] sm:text-[10px] text-tk-tertiary">
              <span className="w-1.5 h-1.5 rounded-full shrink-0 bg-tk-muted" />
              <span className="text-tk-text-muted">Built for the AI search era</span>
            </span>
          </div>
        </div>
      </div>
