...
import { ArrowRightIcon } from "@/pages/home2/sections/Nav/icons";
...
export function Revenue() {
  ...
  return (
    <>
      ...
      <section id="revenue-section" ref={ref} className="bg-tk-surface relative">
        <div className="px-4 lg:px-8">
          <div className="mx-auto" style={{ maxWidth: 1120 }}>
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 border-b border-tk-default">
                <div
                  className={`lg:col-span-4 p-4 sm:p-6 lg:p-8 flex flex-col justify-center lg:border-r border-tk-default border-b lg:border-b-0 transition-all duration-700 ${
                    isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
                  style={{ transitionTimingFunction: EASE }}
                >
                  <div className="flex items-baseline gap-0.5">
                    <span className="text-[28px] sm:text-[32px] lg:text-[36px] font-semibold tracking-tight leading-none text-tk-accent tabular-nums">
                      $15
                    </span>
                    <span className="text-[14px] sm:text-[16px] lg:text-[18px] font-semibold text-tk-accent/60 leading-none">
                      .17
                    </span>
                  </div>
                  <span className="text-[10px] font-medium text-tk-text-muted uppercase tracking-wider mt-1.5">
                    Avg. session value
                  </span>
                </div>
                <div
                ...
                >
                  <h2 className="text-[18px] sm:text-[24px] lg:text-[28px] font-semibold text-tk-primary tracking-[-0.02em] leading-[1.2] mb-2">
                    See where your AI visibility comes from
                  </h2>
                  <p className="text-[13px] sm:text-[14px] text-tk-secondary leading-relaxed max-w-xl">
              ...
              <div className="border-t border-tk-default">
                ...
                >
                  <div className="flex flex-wrap items-center gap-2.5 sm:gap-4 lg:gap-6">
                    <span className="text-[10px] sm:text-[12px] text-tk-secondary flex items-center gap-1">
                      <CheckCircleIcon className="w-3 h-3 text-tk-accent flex-shrink-0" />
                      10-min setup
                    </span>
                    <span className="text-[10px] sm:text-[12px] text-tk-secondary flex items-center gap-1">
                      <CheckCircleIcon className="w-3 h-3 text-tk-accent flex-shrink-0" />
                    ...
                    <span className="hidden sm:flex text-[10px] sm:text-[12px] text-tk-secondary items-center gap-1.5">
                      <CheckCircleIcon className="w-3 h-3 text-tk-accent flex-shrink-0" />
                      Weekly reports
                    </span>
                  </div>
                  <a
                    href="/register"
                    className="text-[10px] sm:text-[12px] font-medium text-tk-accent hover:text-tk-accent-hover flex items-center gap-1 transition-colors flex-shrink-0"
                  >
                    Get Started
