      ...
      <MegaMenuPanel isOpen={isOpen} id={MENU_ID} width="w-[560px]">
        <div className="grid grid-cols-[220px_1fr]">
          <a
            ...
            className={`
              group p-6 border-r border-tk-default flex flex-col gap-3
              hover:bg-tk-accent-subtle/30 transition-colors
          ...
          >
            ...
            <div>
              <div className="text-[15px] font-semibold text-tk-primary tracking-tight leading-tight transition-colors group-hover:text-tk-accent-hover">
              ...
              <span className="text-[11.5px] font-medium text-tk-accent inline-flex items-center gap-1 mt-3">
                Explore
                <ArrowRightIcon
                  size={11}
              ...
              {resourcesList.map((item, index) => (
                <a
                  ...
                  className={`
                    ...
                    transition-colors hover:bg-tk-accent-subtle/40
                    ${isOpen ? "opacity-100 translate-y-0" : "opacity-0 translate-y-1"}
                  `}
                  style={{
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[13px] font-semibold text-tk-primary leading-tight tracking-tight transition-colors group-hover:text-tk-accent-hover">
                      {item.name}
                    </div>
                    <div
            ...
            >
              ...
              {resourcesFooterLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="text-[11.5px] tracking-tight hover:text-tk-accent-hover transition-colors"
                  style={{ color: "var(--color-text-muted)" }}
                >
                  {link.name}
                </a>
