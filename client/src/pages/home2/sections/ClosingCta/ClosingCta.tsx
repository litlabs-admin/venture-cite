...
export function ClosingCta() {
  ...
  const dotGridStyle = {
    "--mkt-dot-opacity": 0.08,
    "--mkt-dot-spacing": "9px",
    "--mkt-dot-size": "0.8px",
  } as CSSProperties;

  return (
    <section id="closing-cta" ref={ref} className="relative bg-tk-surface py-16 sm:py-24 lg:py-32">
      <div
      ...
      <div className="px-4 lg:px-8">
        <div className="mx-auto" style={{ maxWidth: 1120 }}>
          ...
          >
            <h2 className="text-[20px] sm:text-[28px] lg:text-[32px] font-semibold text-tk-primary tracking-[-0.02em] leading-[1.2] mb-3 sm:mb-4">
              Get cited by AI search engines<span className="text-tk-accent">.</span>
              <br />
              Track every mention. Optimize every prompt.
            </h2>
            <p className="text-[13px] sm:text-[14px] lg:text-[16px] text-tk-secondary leading-relaxed mb-6 sm:mb-8 max-w-[520px] mx-auto">
