...
function FeatureText({
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 pt-5 sm:pt-8 lg:pt-10 flex flex-col bg-white">
      ...
      >
        <div className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.2em] text-tk-accent mb-1 sm:mb-2">
          {eyebrow}
        </div>
        <h3 className="text-[16px] sm:text-[20px] lg:text-[24px] font-semibold text-tk-primary tracking-[-0.02em] leading-[1.15] mb-2 sm:mb-3">
          {heading}
        </h3>
        <p className="text-[12px] sm:text-[14px] text-tk-secondary leading-relaxed mb-3 sm:mb-5 max-w-[380px]">
          {body}
        </p>
        <a
          href={href}
          className="inline-flex items-center gap-2 text-[11px] sm:text-[13px] font-semibold text-tk-accent hover:text-tk-accent-hover transition-colors duration-150 group"
        >
          {linkText}
          <ArrowRightIcon
            size={14}
...
export function Platform() {
  ...
  return (
    <>
      ...
      <section id="platform-section" ref={ref} className="bg-tk-surface relative">
        <div className="px-4 lg:px-8">
          <div className="mx-auto" style={{ maxWidth: 1120 }}>
            ...
            >
              <div className="border border-tk-default overflow-hidden bg-white">
                {/* Row 01 — Track (text left, mockup right) */}
                <div className="border-b border-tk-default">
                  <div className="grid grid-cols-1 lg:grid-cols-[40%_60%]">
                    <div className="lg:border-r border-tk-default">
                      <FeatureText
                        number="01"
                        eyebrow="Track"
                    ...
                    <div className="border-t lg:border-t-0 border-tk-default">
                ...
                <div className="border-b border-tk-default">
                  <div className="grid grid-cols-1 lg:grid-cols-[60%_40%]">
                    <div className="order-2 lg:order-1 border-t lg:border-t-0 lg:border-r border-tk-default">
