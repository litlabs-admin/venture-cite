...
const aiEngines: AIEngine[] = [
  {
    ...
    bgColor: "bg-muted",
    description:
      "OpenAI's ChatGPT prioritizes authoritative sources, Wikipedia, and well-structured content with clear facts.",
    keyFactors: [
      "Wikipedia presence",
    ...
    steps: [
      {
        ...
        description:
          "ChatGPT's search mode uses Bing's index. Submitting your site and sitemap to Bing Webmaster Tools ensures ChatGPT can find and cite your content in real-time searches.",
        howTo:
          "Go to bing.com/webmasters, sign in with a Microsoft account, add your site URL, verify ownership via DNS/meta tag, then submit your sitemap.xml. Monitor the crawl status regularly.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "If you sell products, register on ChatGPT's Instant Checkout program. This lets your products appear directly in ChatGPT's shopping recommendations with buy buttons.",
        howTo:
      ...
      },
      {
        ...
        description:
          "OpenAI uses several crawlers to index your site. You must explicitly allow them in your robots.txt file for ChatGPT to cite your content.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Wikipedia is one of ChatGPT's primary knowledge sources. Having a Wikipedia page or being cited on relevant Wikipedia articles significantly increases citation likelihood.",
        howTo:
      ...
      },
      {
        ...
        description:
          "ChatGPT synthesizes information from multiple sources. Having consistent, accurate facts across the web helps it cite you correctly.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Backlinks from high-authority domains signal trustworthiness to ChatGPT's training data.",
        howTo:
      ...
      },
      {
        ...
        howTo:
          "Implement Organization, Product, Article, and FAQ schema on your website. Use Google's Structured Data Testing Tool to validate.",
        priority: "medium",
  ...
  },
  {
    ...
    bgColor: "bg-muted",
    description:
      "Anthropic's Claude values nuanced, well-reasoned content with clear sourcing and ethical considerations.",
    keyFactors: [
    ...
    steps: [
      {
        ...
        description:
          "Anthropic uses multiple crawlers: ClaudeBot (training), Claude-SearchBot (search indexing), and Claude-User (user-triggered fetching). Allowing these ensures Claude can discover and cite your content.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Claude processes very long documents (200K+ tokens). Creating comprehensive, well-organized long-form content with clear section headings gives Claude more to work with and cite.",
        howTo:
          "Create detailed resource pages, comprehensive guides, and thorough documentation. Use clear H2/H3 headings, table of contents, and logical structure. Claude excels with in-depth content over surface-level pieces.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Claude appreciates content that acknowledges complexity and presents multiple perspectives fairly.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Claude values verifiable information with clear attribution to original sources.",
        howTo:
          "Include inline citations, reference lists, and links to primary sources in your content. Use academic citation formats where appropriate.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Original research and proprietary data give Claude unique information to cite.",
        howTo:
          "Conduct surveys, analyze industry data, or compile unique datasets. Publish findings in detailed reports.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Claude's training emphasizes ethical considerations. Highlighting responsible practices can improve visibility.",
        howTo:
          "Publish sustainability reports, ethical guidelines, and social responsibility initiatives. Be transparent about business practices.",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "Claude excels at explanation and education. Content that teaches concepts well tends to get cited.",
        howTo:
          "Create how-to guides, explainers, and tutorials that break down complex topics. Use clear examples and analogies.",
        priority: "medium",
  ...
  },
  {
    ...
    bgColor: "bg-muted",
    description:
      "Perplexity performs real-time web searches, prioritizing fresh, authoritative content with clear structure.",
    ...
    steps: [
      {
        ...
        description:
          "Perplexity searches the web in real-time. You must allow its crawler to access your site for any chance of being cited in Perplexity answers.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Perplexity's Publisher Program offers revenue sharing (80/20 split), free API access, and enhanced analytics for how your content gets cited.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Perplexity needs to access your content in real-time. Blocked crawlers mean no citations.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Perplexity looks for concise, direct answers to user queries. Structure content to provide clear takeaways.",
        howTo:
          "Use clear headings that match search queries. Start sections with direct answers before expanding on details.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Perplexity performs real-time searches and prefers recent content. Outdated content gets deprioritized.",
        howTo:
          "Regularly update existing content with new information. Add 'Last Updated' dates and refresh statistics annually.",
        priority: "high",
      ...
      },
      {
        ...
        howTo:
          "Create numbered lists, definition paragraphs, and comparison tables. Use clear H2/H3 headings.",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "Cover topics comprehensively with interlinked content to establish domain expertise.",
        howTo:
  ...
  },
  {
    ...
    bgColor: "bg-muted",
    description:
      "Google's AI Overview uses its search index and prioritizes E-E-A-T signals (Experience, Expertise, Authority, Trust).",
    ...
    steps: [
      {
        ...
        description:
          "Google AI Overview pulls from its search index. Verifying your site in Search Console ensures Google knows about all your pages and can include them in AI-generated answers.",
        howTo:
          "Go to search.google.com/search-console, add your property, verify via DNS/HTML tag, submit your sitemap.xml, and monitor coverage reports. Fix any crawl errors promptly.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "For any business with a physical location or service area, Google Business Profile feeds directly into AI responses for local and business-related queries.",
        howTo:
      ...
      },
      {
        ...
        description:
          "A Knowledge Panel gives your brand a verified presence in Google's knowledge graph, which directly feeds into AI Overview responses.",
        howTo:
          "Search for your brand on Google. If a Knowledge Panel appears, click 'Claim this knowledge panel' at the bottom. If not, build your brand's presence on Wikipedia, Wikidata, and authoritative sources until one appears.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Google AI Overview pulls from sites that already rank well in traditional search. Strong SEO is foundational.",
        howTo:
      ...
      },
      {
        ...
        howTo:
          "Add detailed author bios with credentials. Link to author profiles on LinkedIn, publications, and speaking engagements.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "AI Overview selects content that clearly and concisely answers search queries.",
        howTo:
      ...
      },
      {
        ...
        howTo:
          "Encourage customer reviews on Google Business Profile, industry review sites, and your own site.",
        priority: "medium",
      ...
      },
      {
        ...
        howTo:
          "Add FAQ, HowTo, Article, Organization, and Product schema. Validate with Rich Results Test.",
        priority: "medium",
  ...
  },
  {
    ...
    bgColor: "bg-muted",
    description:
      "Google's Gemini leverages Google's vast index and multimodal capabilities, favoring comprehensive, well-structured content.",
    keyFactors: [
    ...
    steps: [
      {
        ...
        description:
          "Gemini pulls primarily from Google's search index and knowledge graph. All Google registrations directly benefit your Gemini visibility.",
        howTo:
          "Complete the Google AI Overview registration steps first (Search Console + Business Profile). These same registrations power Gemini's data sources.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "If you sell products, Google Merchant Center data feeds into Gemini's product recommendations and shopping features.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Gemini primarily draws from Google's search index. High search rankings correlate with Gemini citations.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Gemini is multimodal and can process images and videos. Rich media content may get additional visibility.",
        howTo:
          "Include original images, infographics, and videos in content. Add descriptive alt text and transcripts.",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "Gemini appears to weight brand recognition and search volume for brand terms.",
        howTo:
          "Invest in brand awareness through PR, advertising, and social media. Monitor branded search volume.",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "For local and business queries, Google Business Profile data feeds into Gemini responses.",
      ...
      },
      {
        ...
        description:
          "Gemini prefers sources that thoroughly cover a topic rather than superficial content.",
        howTo:
          "Build comprehensive resource centers on your key topics. Cover all aspects and frequently asked questions.",
        priority: "medium",
  ...
  },
  {
    ...
    bgColor: "bg-muted",
    description:
      "xAI's Grok has real-time access to X (Twitter) data and web search, prioritizing current information and social proof.",
    keyFactors: [
      "X/Twitter presence",
    ...
    steps: [
      {
        ...
        description:
          "Grok has direct access to X data. A verified business account (gold checkmark) signals authority and increases the likelihood of being cited in Grok responses.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Grok performs web searches beyond X data. Ensuring your site is crawlable by xAI's bots increases your chances of being cited.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Grok has direct access to X data. Active, authoritative accounts get cited more frequently.",
        howTo:
          "Post regularly on X with industry insights. Build followers, engage in discussions, and become a recognized voice in your space.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Grok emphasizes real-time information. Being first with accurate news improves visibility.",
        howTo:
          "Monitor industry news and share breaking updates with your expert commentary. Be a reliable source for timely information.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Grok learns from public discourse. Participating in visible discussions increases citation likelihood.",
        howTo:
          "Reply to industry threads, participate in X Spaces, and engage with other thought leaders publicly.",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "Grok performs web searches. Make sure your site is accessible and well-indexed.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Grok tends to surface diverse viewpoints. Unique, well-reasoned takes stand out.",
        howTo:
          "Don't just repeat conventional wisdom. Offer fresh perspectives backed by data or experience.",
        priority: "medium",
  ...
  },
  {
    ...
    bgColor: "bg-muted",
    description:
      "Manus is an autonomous AI agent that executes tasks by browsing the web. It values actionable, structured information.",
    keyFactors: [
      "Structured content",
      "Clear CTAs",
    ...
    steps: [
      {
        ...
        description:
          "Manus browses websites autonomously like a real user, but may not execute all JavaScript. Critical content should be available in the initial HTML for Manus to discover and use.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Manus compares options and makes recommendations. Having structured, machine-readable data (JSON-LD, API endpoints) makes it easier for Manus to understand and recommend your offerings.",
        howTo:
          "Implement Schema.org Product, Service, and Organization markup. Include pricing, features, availability, and reviews in structured format. Consider providing a public API or data feed for your products.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Manus executes tasks autonomously. Content structured as step-by-step guides gets used in workflows.",
        howTo:
          "Create clear how-to guides, tutorials, and documentation with numbered steps. Make content actionable.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Manus looks for actionable next steps. Clear CTAs help it recommend your solutions.",
        howTo:
          "Include obvious buttons, links, and instructions for taking action. Make conversion paths clear.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Manus browses websites like a user. Ensure your site is navigable and content is accessible.",
        howTo:
      ...
      },
      {
        ...
        description:
          "Manus researches and compares options. Comprehensive information helps it recommend you.",
        howTo:
          "Include pricing, features, comparisons, and FAQs on your site. Answer common questions proactively.",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "Manus can complete tasks like booking or contacting. Current information enables conversions.",
        howTo:
          "Keep contact forms, booking systems, and availability information current and accessible.",
        priority: "medium",
  ...
  },
  {
    ...
    bgColor: "bg-muted",
    description:
      "DeepSeek is a rapidly growing AI search engine from China that values authoritative technical content and structured data.",
    keyFactors: [
      "Crawler access",
    ...
    steps: [
      {
        ...
        description:
          "DeepSeek uses DeepSeekBot to index content. If your robots.txt blocks unknown crawlers, DeepSeek can't discover your site.",
        howTo:
      ...
      },
      {
        ...
        description:
          "DeepSeek prioritizes factually accurate, technically deep content. Surface-level marketing copy rarely gets cited.",
        howTo:
          "Write long-form technical articles with concrete data, code examples, benchmarks, and citations to primary sources.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Structured data helps DeepSeek understand the semantic meaning of your pages.",
        howTo:
          "Implement Schema.org Organization, Product, Article, and FAQ markup using JSON-LD. Validate with Google's Rich Results Test.",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "DeepSeek, like other AI engines, weighs external authority signals. Citations from trusted sources lift your rankings.",
        howTo:
          "Get mentioned on industry publications, Wikipedia, GitHub READMEs, academic papers, and reputable blogs. Quality over quantity.",
        priority: "medium",
      ...
      },
      {
        ...
        description:
          "DeepSeek is releasing indexing APIs. Early adopters who submit content directly get faster inclusion.",
        howTo:
          "Check platform.deepseek.com for indexing API documentation. When available, submit new articles programmatically.",
        priority: "low",
...
export default function AIVisibility() {
  ...
  const toggleStepMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await apiRequest(method, `/api/visibility-progress/${selectedBrandId}`, {
        engineId,
        stepId,
      });
  ...
  const getPriorityBadge = (priority: string) => {
    switch (priority) {
      case "high":
        return (
          <Badge className="bg-foreground text-background border-transparent">High Priority</Badge>
        );
      case "medium":
    ...
    <div className="space-y-8">
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-bold" data-testid={`engine-progress-${engine.id}`}>
                      {progress.completed}/{progress.total}
                    </p>
      ...
      <Card className="mt-8 bg-card border border-border">
        <CardHeader>
          ...
          <CardDescription>
            These high-priority steps give you the best return on effort
          </CardDescription>
        </CardHeader>
        <CardContent>
