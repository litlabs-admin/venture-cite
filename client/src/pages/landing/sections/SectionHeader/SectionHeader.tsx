      ...
      <div className="mx-auto border-t border-vc-default opacity-100" style={{ maxWidth: 1120 }}>
        <div className="py-2.5 sm:py-3 lg:py-3.5 px-4 sm:px-6 flex items-center justify-between">
          <div className="flex items-center gap-3 opacity-100 translate-x-0">
            ...
            <span className="text-[11px] font-semibold tracking-[0.08em] text-vc-text-muted uppercase">
              {label}
            </span>
          </div>
          <span className="hidden sm:block text-[10px] text-vc-text-muted tracking-wide opacity-100 translate-x-0">
            / {subtitle}
          </span>
        </div>
      </div>
