          ...
          <>
              ...
              <TabsContent value="platform-breakdown" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      See which AI platforms drive the most revenue
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {Object.entries(analytics?.platformBreakdown || {}).length === 0 ? (
                      <div className="text-center py-12 text-muted-foreground">
                        ...
                        <p className="text-sm mt-2">Connect your e-commerce platform to start tracking AI-driven sales</p>
                      </div>
                    ) : (
              ...
              <TabsContent value="recent-purchases" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Latest AI-driven purchases from your content
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        {analytics?.recentPurchases.map((purchase) => (
                          ...
                          >
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-muted-foreground">
                                {purchase.ecommercePlatform} • {purchase.quantity}x • {new Date(purchase.purchasedAt).toLocaleDateString()}
                              </p>
                            </div>
                            <div className="text-right">
            ...
            <Card className="mt-6">
              <CardHeader>
                ...
                <CardDescription>Connect your e-commerce platform to track AI-driven purchases</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="space-y-2 text-sm font-mono bg-muted p-4 rounded-lg">
                    <p><strong>Shopify:</strong> POST /webhooks/shopify/orders</p>
                    <p><strong>Stripe:</strong> POST /webhooks/stripe/checkout</p>
                    <p><strong>Generic:</strong> POST /webhooks/ecommerce/purchase</p>
                  </div>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">Attribution Setup:</h3>
                  <p className="text-sm text-muted-foreground">
                    Include article_id and brand_id in order metadata or URL parameters to track which content drives sales.
                  </p>
                </div>
              </CardContent>
            </Card>
