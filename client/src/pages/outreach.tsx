...
export default function Outreach() {
  ...
  const { data: statsData } = useQuery<{
    data: { total: number; byStatus: Record<string, number>; successRate: number };
  }>({
  ...
  const { data: emailStatsData } = useQuery<{
    data: { sent: number; opened: number; replied: number; openRate: number; replyRate: number };
  }>({
  ...
  // Deep link: /outreach?emailId=<id> — scroll to and highlight that row.
  const search = useSearch();
  const deepLinkEmailId = new URLSearchParams(search).get("emailId");
  ...
  useEffect(() => {
    if (!deepLinkEmailId || deepLinkHandled.current) return;
    // Wait until the emails list has loaded.
    if (emailsLoading) return;
    deepLinkHandled.current = true;
    const match = emails.find((e) => e.id === deepLinkEmailId);
    if (!match) {
      toast({
        title: "Email not found",
        description: "The outreach email you linked to no longer exists.",
      });
      return;
    }
    setHighlightedEmailId(deepLinkEmailId);
    // Scroll after the next paint so the ref is populated.
    requestAnimationFrame(() => {
      const el = emailRefs.current[deepLinkEmailId];
      el?.scrollIntoView({ behavior: "smooth", block: "center" });
    });
    // Clear the highlight after a few seconds.
    const t = setTimeout(() => setHighlightedEmailId(null), 4000);
    return () => clearTimeout(t);
  }, [deepLinkEmailId, emailsLoading, emails, toast]);
  ...
  const findContactsMutation = useMutation({
    mutationFn: async (targetId: string) => {
      const response = await apiRequest(
        "POST",
        `/api/publication-targets/${targetId}/find-contacts`,
      );
      return response.json();
    },
    onSuccess: () => {
  ...
  return (
    <>
      <Helmet>
        <title>Outreach - VentureCite</title>
      </Helmet>
          ...
          <Tabs defaultValue="discover" className="space-y-6">
            ...
            <TabsContent value="discover" className="space-y-6">
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-discovered">
                          {publications.length}
                        </p>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-contacts">
                          {publications.filter((p) => p.contactEmail).length}
                        </p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-guest">
                          {publications.filter((p) => p.acceptsGuestPosts === 1).length}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-da">
                          {publications.length > 0
                            ? Math.round(
                                publications.reduce((sum, p) => sum + (p.domainAuthority || 0), 0) /
                                  publications.length,
                              )
                            : 0}
                        </p>
              ...
              <div
                ...
                data-testid="banner-publication-discovery"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p
                      ...
                      data-testid="text-publication-discovery"
                    >
                      Publication Discovery - Coming Soon
                    </p>
                    <p className="text-amber-700 dark:text-amber-300 text-sm mt-1">
                      Automated publication discovery with real contact databases is in development.
                      For now, use the Campaigns tab to manually track your outreach efforts.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-opened">
                          {emailStats?.opened || 0}
                        </p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-replied">
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-open-rate">
                          {(emailStats?.openRate || 0).toFixed(0)}%
                        </p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-reply-rate">
                          {(emailStats?.replyRate || 0).toFixed(0)}%
                        </p>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-progress">
                          {(stats?.byStatus?.sent || 0) + (stats?.byStatus?.follow_up || 0)}
                        </p>
                      </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-rate">
                  ...
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-bold" data-testid="stat-accepted">
                      ...
                      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
                        ...
                        <DialogContent className="max-w-lg">
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              Set up a new publication outreach campaign
                            </DialogDescription>
                          </DialogHeader>
                          <div className="space-y-4">
                            <div>
                            ...
                            <div>
                              ...
                              <Select
                                ...
                                onValueChange={(v) =>
                                  setNewCampaign({ ...newCampaign, campaignType: v })
                                }
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="correction_request">
                                    Correction Request
                                  </SelectItem>
                                </SelectContent>
                              </Select>
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setNewCampaign({ ...newCampaign, targetDomain: e.target.value })
                                }
                              ...
                              <div>
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    setNewCampaign({
                                      ...newCampaign,
                                      targetContactName: e.target.value,
                                    })
                                  }
                              ...
                              <div>
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    setNewCampaign({
                                      ...newCampaign,
                                      targetContactEmail: e.target.value,
                                    })
                                  }
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setNewCampaign({ ...newCampaign, proposedTopic: e.target.value })
                                }
                            ...
                            <div>
                              ...
                              <Textarea
                                ...
                                onChange={(e) =>
                                  setNewCampaign({ ...newCampaign, pitchAngle: e.target.value })
                                }
                                ...
                                <div className="flex-1">
                                  ...
                                  {campaign.proposedTopic && (
                                    <p className="text-sm mt-2">
                                      <strong>Topic:</strong> {campaign.proposedTopic}
                                    </p>
                                  )}
                                </div>
                                <div className="flex gap-2">
                                  {campaign.status === "draft" && (
                                    <>
                                      <Button
                                        size="sm"
                                        variant="outline"
                                        onClick={() => generateDraftMutation.mutate(campaign.id)}
                                        data-testid={`btn-generate-${campaign.id}`}
                                      >
                                      ...
                                      <Button
                                        ...
                                        data-testid={`btn-send-${campaign.id}`}
                                      >
                                  ...
                                  {campaign.status === "sent" && (
                                    <Button
                                      ...
                                      data-testid={`btn-followup-${campaign.id}`}
                                    >
                                      <RefreshCw className="w-3 h-3 mr-1" /> Follow Up
                                    </Button>
                                  )}
                                  {(campaign.status === "sent" ||
                                    campaign.status === "follow_up") && (
                                    <>
                                      <Button
                                        size="sm"
                                        variant="outline"
                                        ...
                                        data-testid={`btn-accept-${campaign.id}`}
                                      >
                                      ...
                                      <Button
                                        ...
                                        data-testid={`btn-reject-${campaign.id}`}
                                      >
                                  ...
                                  {campaign.resultUrl && (
                                    ...
                                    >
                                      <Button
                                        size="sm"
                                        variant="outline"
                                        data-testid={`btn-result-${campaign.id}`}
                                      >
        ...
        <Dialog open={showEmailDialog} onOpenChange={setShowEmailDialog}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                {selectedTarget &&
                  `Sending to ${selectedTarget.contactName} at ${selectedTarget.publicationName}`}
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) => setNewEmail({ ...newEmail, emailType: v })}
                >
              ...
              <div className="flex gap-2">
                ...
                >
                  {createEmailMutation.isPending || sendEmailMutation.isPending ? (
                    <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                  ) : (
