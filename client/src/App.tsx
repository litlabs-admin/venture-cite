...
import { startStaticMetaDescriptionDedup } from "@/lib/dedupeStaticMeta";
...
function App() {
  // Remove the static crawler-fallback <meta name="description"> (see
  // client/index.html:19-22) once Helmet mounts a page-specific one, so
  // hydrated pages never end up with two description tags. See
  // client/src/lib/dedupeStaticMeta.ts for the full rationale.
  useEffect(() => startStaticMetaDescriptionDedup(), []);
