...
const NAV: NavEntry[] = [
...

  {
    ...
    brandScoped: true,
    keywords:
      "analytics visibility report citations cited prompts runs scan competitors rivals share of voice leaderboard trends history over time mentions reddit hacker news detected",
  },

  {
    ...
    brandScoped: true,
    keywords:
      "hallucinations inaccurate false claims accuracy coverage listicles wikipedia placements best of missing signals geo chunkability schema readiness crawler robots gptbot permissions blocked recommendations next steps",
  },
