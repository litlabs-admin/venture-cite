...
export const DEST = {
  ...
  // The prompts list inside the Monitor spine. The standalone /prompts page
  // this used to point at has no entry in the nav, so every panel link into it
  // dropped the reader outside the workflow; /prompts/ now redirects here too,
  // and /prompts/$promptId stays the detail page these rows open.
